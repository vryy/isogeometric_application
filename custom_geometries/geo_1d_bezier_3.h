...
//
//
#if !defined(KRATOS_GEO_1D_BEZIER_3_H_INCLUDED )
#define  KRATOS_GEO_1D_BEZIER_3_H_INCLUDED
...
/**
 * A geometry representing Bezier decomposition of a NURBS curve in 3D space
 */
template<class TPointType>
class Geo1dBezier3: public Geo1dBezier<TPointType>
{
public:
    ...
    /**
     * Pointer definition of Geo1dBezier3
     */
    KRATOS_CLASS_POINTER_DEFINITION( Geo1dBezier3 );
    ...
    Geo1dBezier3() : BaseType( PointsArrayType() )
    {}

    Geo1dBezier3(const PointsArrayType& ThisPoints)
        : BaseType( ThisPoints )
    {}
     ...
     */
    Geo1dBezier3( Geo1dBezier3 const& rOther )
        : BaseType( rOther )
    {}
     ...
     * source geometry's points too.
     */
    template<class TOtherPointType> Geo1dBezier3( Geo1dBezier3<TOtherPointType> const& rOther )
        : BaseType( rOther )
    {}
     ...
     * @see ClonePoints
     */
    Geo1dBezier3& operator=( const Geo1dBezier3& rOther )
    {
    ...
    Geo1dBezier3& operator=( Geo1dBezier3<TOtherPointType> const & rOther )
    {
        BaseType::operator=( rOther );
        return *this;
    }
    ...
    {
        Geo1dBezier3::Pointer pNewGeom = Geo1dBezier3::Pointer( new Geo1dBezier3( ThisPoints ) );
...
////        p_clone( new Geo1dBezier3< Point<3> >( NewPoints ) );
...
//    }
    ...
    GeometryData::KratosGeometryType GetGeometryType() const final
    {
        ...
        return static_cast<GeometryData::KratosGeometryType>(IsogeometricGeometryData::KratosIsogeometricGeometryType::Kratos_Bezier1D3);
#else
        return GeometryData::KratosGeometryType::Kratos_Bezier1D3;
#endif
    }
    ...
    ) final
    {
        ...
        BaseType::mpBezierGeometryData = BezierUtils::RetrieveIntegrationRule<1, 3, 1>(NumberOfIntegrationMethod, Degree1);
...
private:
    ...
    template<class TOtherPointType> friend class Geo1dBezier3;
...
template<class TPointType> inline std::istream& operator >>(
    std::istream& rIStream, Geo1dBezier3<TPointType>& rThis);

/**
 * output stream function
 */
template<class TPointType> inline std::ostream& operator <<(
    std::ostream& rOStream, const Geo1dBezier3<TPointType>& rThis)
{
...
#endif // KRATOS_GEO_1D_BEZIER_3_H_INCLUDED
