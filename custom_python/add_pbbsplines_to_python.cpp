...
void IsogeometricApplication_AddPBBSplinesSpaceToPython(pybind11::module& m)
{
    ...
    pybind11::class_<PBBSplinesBasisFunctionType, typename PBBSplinesBasisFunctionType::Pointer>(m, ss.str().c_str())
    ...
    pybind11::class_<PBBSplinesFESpaceType, typename PBBSplinesFESpaceType::Pointer, FESpaceType>(m, ss.str().c_str())
    .def(pybind11::init<>())
...
void IsogeometricApplication_AddPBBSplinesToPython(pybind11::module& m)
{
    ...
    pybind11::class_<MultiPBBSplinesPatchMatlabExporter, MultiPBBSplinesPatchMatlabExporter::Pointer>
