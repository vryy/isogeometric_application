...
void IsogeometricApplication_AddTSplinesToPython(pybind11::module& m)
{
    ...
    class_<TsMesh2D, TsMesh2D::Pointer>
    (m, "TsMesh2D")
    .def(init<>())
    ...
    class_<TSplinesFESpaceType, TSplinesFESpaceType::Pointer, PBBSplinesFESpaceType>
    (m, "TSplinesFESpace2D")
    .def(init<>())
    ...
    class_<NonConformingTSplinesMultipatchLagrangeMeshType, typename NonConformingTSplinesMultipatchLagrangeMeshType::Pointer>
    (m, "NonConformingTSplinesMultipatchLagrangeMesh")
    .def(init<typename MultiPatch<2>::Pointer>())
    ...
    class_<TSplinesUtils, TSplinesUtils::Pointer>
    (m, "TSplinesUtils")
    .def(init<>())
    ...
    #ifdef ISOGEOMETRIC_USE_TSPLINE
    class_<TSplinesPatchTSMImporter, TSplinesPatchTSMImporter::Pointer>
