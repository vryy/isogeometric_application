...
// template<typename TLocalCoordinateType>
// void BSplinesFESpace_Helper<2>::GetValues<TLocalCoordinateType>(const BSplinesFESpace<2, TLocalCoordinateType>& rFESpace,
//         std::vector<double>& values, const std::vector<TLocalCoordinateType>& xi)
// {
...
// template<typename TLocalCoordinateType>
// void BSplinesFESpace_Helper<2>::GetValuesAndDerivatives<TLocalCoordinateType>(const BSplinesFESpace<2, TLocalCoordinateType>& rFESpace,
//         std::vector<double>& values, std::vector<std::vector<double> >& derivatives, const std::vector<TLocalCoordinateType>& xi)
// {
//     // initialize the shape functions and derivatives
//     if (values.size() != rFESpace.TotalNumber())
...
// template<typename TLocalCoordinateType>
// void BSplinesFESpace_Helper<3>::GetValues<TLocalCoordinateType>(const BSplinesFESpace<3, TLocalCoordinateType>& rFESpace,
//         std::vector<double>& values, const std::vector<TLocalCoordinateType>& xi)
// {
//     // initialize the shape functions
//     if (values.size() != rFESpace.TotalNumber())
...
// template<typename TLocalCoordinateType>
// void BSplinesFESpace_Helper<3>::GetValuesAndDerivatives<TLocalCoordinateType>(const BSplinesFESpace<3, TLocalCoordinateType>& rFESpace,
//         std::vector<double>& values, std::vector<std::vector<double> >& derivatives, const std::vector<TLocalCoordinateType>& xi)
// {
//     // initialize the shape functions and derivatives
//     if (values.size() != rFESpace.TotalNumber())
