...
print("######CREATE PATCH#######")
fes1 = nurbs_fespace_library.CreateLinearFESpace(4)
ctrl_grid_1 = StructuredControlPointGrid1D(5)
#print(fes1)
...
ctrl_grid_1.SetValue(4, ControlPoint(3.0, 2.0, 0.0, 1.0))
#print(ctrl_grid_1)
...
mpatch_export3.Export(mpatch, "curve2.m")
