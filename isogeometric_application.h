...
namespace Kratos
{
    ...
    KRATOS_DEFINE_APPLICATION_VARIABLE( ISOGEOMETRIC_APPLICATION, ControlPoint<double>, CONTROL_POINT )
    ...
    KRATOS_DEFINE_APPLICATION_VARIABLE( ISOGEOMETRIC_APPLICATION, int, INTEGRATION_ORDER )
